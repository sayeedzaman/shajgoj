                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center justify-between mb-1">
                      <p className={`truncate ${conversation.adminUnreadCount > 0 ? 'font-bold text-gray-900' : 'font-medium text-gray-900'}`}>
                    ...
                    <div className="flex items-center gap-2">
                      <p className={`text-xs truncate ${conversation.adminUnreadCount > 0 ? 'text-gray-900 font-semibold' : 'text-gray-500'}`}>
