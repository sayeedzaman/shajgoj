...
export const metadata: Metadata = {
  title: 'Shajgoj - Your Beauty Destination',
  description: 'Shop authentic beauty products with fast delivery, easy returns, and secure payments',
  keywords: ['beauty', 'cosmetics', 'makeup', 'skincare', 'haircare', 'Bangladesh'],
};
          ...
          <footer className="bg-gray-900 text-white py-12 mt-20">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                <div>
                  <h3 className="text-lg font-semibold mb-4 gradient-text">Shajgoj</h3>
              ...
              <div className="border-t border-gray-800 mt-8 pt-8 text-center text-sm text-gray-400">
                <p>&copy; {new Date().getFullYear()} Shajgoj. All rights reserved.</p>
              </div>
            </div>
          </footer>
        </AuthProvider>
